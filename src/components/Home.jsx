...
const Home = () => {
 ...
 const products = [
  ...
  const sectionBestSeller = useRef(null);
  ...
  const handleMenu = () => {
    sectionMenu.current?.scrollIntoView({ behavior: "smooth" });
  };
  const handleBestseller = () => {
    sectionBestSeller.current?.scrollIntoView({ behavior: "smooth" });
  };
  const handleContact = () => {
      ...
      <div className="page">
        <Grid container spacing={2}>
          <Grid size={{ sm: 12, xs: 12, md: 12, lg: 12 }}>
            ...
            {/* Menu */}
            <div style={{ background: "#f7f7f7" }} ref={sectionMenu}>
            ...
            {/* Best seller */}
            <div style={{ background: "#a9d0be" }} ref={sectionBestSeller}>
              <Container maxWidth="md" sx={{ py: 6 }}>
